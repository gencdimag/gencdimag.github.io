        ...
        <div class="sidenav">
            ...
            <section class="features" style="margin: auto; width: 80%;">
                <div style="width: 100%; height: 100%;">
                    <div>
                        <li class="labels" style="text-align: left; width: fit-content; padding-left: 20vw; color: #0a0a0a;">${nameOBlack}</li>
                        ...
                        <li class="labels" style="text-align: left; width: fit-content; padding-left: 20vw; color: #0a0a0a;">${nameOWhite}</li>
                    </div> 
                </div>
            </section>
            ...
            <div class="footerparent">
                <footer>
                        <div class="sm-footer">
                            ...
                            <a href="https://chat.whatsapp.com/J2Nsh705Nlo9F7MCDdPLki" target="_blank" class="fa-brands fa-whatsapp"></a>
                            <a href="https://github.com/gencdimag/gencdimag.github.io/discussions" target="_blank" class="fa-brands fa-github"></a>
                            <a href="https://www.youtube.com/@NCALSatrancKulubu" target="_blank" class="fa-brands fa-youtube"></a>
                            <a href="https://discord.com/invite/eWTzQFJax5g" target="_blank" class="fa-brands fa-discord"></a>
                        </div>
                        <b>&copy;
                            <span id="copyright">
